    ...
    public class DirectorsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Director != null ? 
                          ...
                          Problem("Entity set 'MoviesContext.Director'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,BirthDate")] Director director)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MoviesContext.Director'  is null.");
            }
            var director = await _context.Director.FindAsync(id);
            if (director != null)
            {
